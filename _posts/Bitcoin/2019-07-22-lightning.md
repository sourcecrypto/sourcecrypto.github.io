...
[marzig76/fulmo](https://github.com/marzig76/fulmo) 
...
[marzig76/fulmo](https://github.com/marzig76/fulmo)
a minimalist c-lightning UI. Contribute to marzig76/fulmo development by creating an account on GitHub.
...
[zap.jackmallers.com](https://zap.jackmallers.com/) 

[breez/breezmobile](https://github.com/breez/breezmobile)
...
[neogeno/shango-lightning-wallet](https://github.com/neogeno/shango-lightning-wallet)
...
A Bitcoin wallet for iOS. Easy to use and secure

[bluewallet.io/lightning](https://bluewallet.io/lightning/) (custodial)
...
An Android wallet for the Lightning Network. Contribute to ACINQ/eclair-mobile development by creating an account on GitHub.

### 💡 media

[djseeds/lncast](https://github.com/djseeds/lncast)
LNCast - Lightning Network Podcatcher. Contribute to djseeds/lncast development by creating an account on GitHub.
...
Twitter Client for Lightning JSON-RPC interface. Contribute to elaineo/LightningBuddy development by creating an account on GitHub.

[blockchain/thunder](https://github.com/blockchain/thunder)
Off-Chain Bitcoin payments using smart contracts . Contribute to blockchain/thunder development by creating an account on GitHub.
...
Discussion of the Bitcoin Lightning Network. Learn more about LN here: [lopp.net/lightning.html](https://lopp.net/lightning.html)
...
A c-lightning plugin that exports all payments to a CSV file - 0xB10C/c-lightning-plugin-csvexportpays

[rsbondi/clightning-mobile](https://github.com/rsbondi/clightning-mobile)
A mobile client to access your clightning node. Contribute to rsbondi/clightning-mobile development by creating an account on GitHub.
...
[pierre_rochard@twitter](https://t.co/qeP2dCJSqp)
“Reality: 99.99% of finance and accounting has Excel on their desktop. They send the most pmts The user interface of open, decentralized finance is @msexcel. A plugin is tablestakes for any crypto project. Integrating with @lightning's gRPC API using C# is a joy! #DeFi ...
...
Admin UI for LND. Contribute to janoside/lnd-admin development by creating an account on GitHub.
...
A simple web dashboard for lnd. Contribute to djmelik/lndash development by creating an account on GitHub.
...
Lightning Network (BOLT). Contribute to nayutaco/ptarmigan development by creating an account on GitHub.
...
[lndwork.com](https://www.lndwork.com/) 
...
[light-tube.surge.sh](http://light-tube.surge.sh/) 
Videos w lightning rewards 
...
[light.yuyaogawa.com/faucet](https://light.yuyaogawa.com/faucet/) >A lightning faucet where you can claim an invoice of 200 sats. Maximum one claim per day.
...
[Lightning Charge](https://github.com/ElementsProject/lightning-charge)
(merchant solution for c-lightning)
...
(Not sure how LNRoute is using the term implementations, some of these seem more like apps that need further sorting within this page)
...
Admin UI for LND. See [lnd-admin.chaintools.io](https://lnd-admin.chaintools.io/) for an example.
...
[opennode.co](https://www.opennode.co/) 
...
chat application that limits messages based on payment via Lightning. Sending a message gets cheaper over time, but doubles when someone pays, resulting in one message per ~10 min! 
...
[kriptode.com/satsforlikes/index.html](https://kriptode.com/satsforlikes/index.html) >Pay people to like your tweets or follow you. 
...
[ElementsProject/nanotip](https://github.com/ElementsProject/nanotip)
...
[bitcointunnels.com](https://www.bitcointunnels.com/) >Bitcoin and Lightning merchandise 
...
[lnroute.com/category/implementations/games](https://lnroute.com/category/implementations/games/)
Bitcoin Lightning Powered Games

[microbet.fun](https://microbet.fun/) 
prediction and betting game - make a prediction about sports events or back/lay the others players bets - backers or layers get all satoshis divided equally amongst each participant. 
...
[poke.lightningwiki.net](https://poke.lightningwiki.net/) >Play Pokémon with your fellow bitcoiners a collaborative gameboy powered by Lightning
...
Mini Casino Roulette >Lightning Network simple casino roulette game 
...
[lightningslotmachine.com](https://www.lightningslotmachine.com/) 
A Lightning Network powered Slot Machine

[LuckyThunder - The Lightning Network Slot Machine](https://www.luckythunder.com/)
LuckyThunder is a slot machine built on top of the bitcoin lightning network
...
WordPress plugin for managing & using your LND node - manage your LND node from your WordPress admin panel - fully functional wallet interface - send / recieve funds with ease - responsive UI adapts to fit any web enabled desktop, tablet or mobile device. - Search Lightning Network graph, manage peer connections, open & close channels with ease. - QR support - WordPress ‘shortcodes’, embed LND functionality directly in your pages and posts. 
...
[ElementsProject/wordpress-lightning-publisher](https://github.com/ElementsProject/wordpress-lightning-publisher)
:zap: Lightning Publisher for WordPress. Contribute to ElementsProject/wordpress-lightning-publisher development by creating an account on GitHub.
...
[darosior/c-simple](https://github.com/darosior/c-simple)
A minimalist/simple Lightning Network mobile wallet. - darosior/c-simple
...
Lightning Network LND generated gRPC classes. Contribute to ndeet/php-ln-lnd-grpc development by creating an account on GitHub.
